...
- [:green_book: &nbsp;&nbsp;User Manuals *Links to manuals for purchased products.*](/househould_manuals)
- [:moneybag: &nbsp;&nbsp;Finance *Financial information.*](/household_finance)
{.links-list}

## :bust_in_silhouette:&nbsp;&nbsp;Personal

- [:camera: &nbsp;&nbsp;Photos *Locations and information on pictures.*](/personal_photos)
- [:heart: &nbsp;&nbsp;Health Records *Personal health records and information.*](/personal/health)
- [:herb:&nbsp;&nbsp;Hobbies *Miscellaneous resources for hobbies.*](/personal_hobbies)
{.links-list}

## :link:&nbsp;&nbsp;Reference

- [::nut_and_bolt:: &nbsp;&nbsp;Hardware *Hardware specific reference material.*](/reference_hardware)
- [:briefcase: &nbsp;&nbsp;Software *Software reference material.*](/reference_software)

{.links-list}
## :thought_balloon:&nbsp;&nbsp;Miscellaneous

- [:memo: &nbsp;&nbsp;Notes *Locations and information on pictures.*](/miscellaneous_notes)
