...
# Plant labels
## Overview
![label_printing_configuration.drawio.png](/label_printing_configuration.drawio.png)<img src="/label_printing_configuration.drawio.png" width="50%" height="50%">{.align-center height="400px" width="400px"}
