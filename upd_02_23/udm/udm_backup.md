...
The Dream Machine configuration is backed up to both the Unifi Cloud and to the QNAP NAS.  

The cloud backup should always be enabled in the UDM console settings.  The [Cloud Config Backup](https://192.168.1.1/settings/system) page shows whether it is enabled or not, and is the support page used to restore and/or backup a configuration to/from the cloud.
