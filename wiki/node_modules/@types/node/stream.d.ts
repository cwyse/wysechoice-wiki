...
declare module 'stream' {
    ...
    namespace internal {
        ...
        class Readable extends Stream implements NodeJS.ReadableStream {
            ...
            /**
             * Passing `chunk` as `null` signals the end of the stream (***REMOVED***) and behaves the
             * same as `readable.push(null)`, after which no more data can be written. The ***REMOVED***
