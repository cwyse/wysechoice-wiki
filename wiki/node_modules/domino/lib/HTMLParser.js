 ...
 * of text, comments, doctype declarations, and the end-of-file (***REMOVED***)
 ...
 * TAG, ENDTAG, TEXT, COMMENT, DOCTYPE and ***REMOVED***.  The second argument is
...
function HTMLParser(address, fragmentContext, options) {
  ...
  var htmlparser = {
    ...
    parse: function(s, end, shouldPauseFunc) {
      ...
      if (reentrant_invocations === 0) {
        ...
        // character will transform into an ***REMOVED*** token.
        // Having an actual character that represents ***REMOVED***
        // in the character buffer makes lookahead regexp
        // matching work more easily, and this is
        // important for character references.
        if (end) {
          s += "\uFFFF";
          input_complete = true; // Makes scanChars() send ***REMOVED***
        }
      ...
      case 'undefined':
        ...
        case 0xFFFF:
          if (input_complete && nextchar === numchars) {
            tokenizer(***REMOVED***); // codepoint will be 0xFFFF here
            break;
          }
          /* falls through */
        default:
  ...
  function getMatchingChars(pattern) {
    ...
    if (match && match.index === nextchar - 1) {
      ...
      /* Careful!  Make sure we haven't matched the ***REMOVED*** character! */
      if (input_complete && nextchar === numchars) {
        // Oops, backup one.
  ...
  function emit***REMOVED***() {
    flushText();
    parser(***REMOVED***); // ***REMOVED*** never goes to insertForeignContent()
   ...
   * is true if the lookahead goes all the way to the ***REMOVED***. (XXX
   ...
   * characters up to and including that sequence, or up to ***REMOVED***.  If
  ...
  function before_attribute_name_state(c) {
    ...
    case 0x0020: // SPACE
      ...
      break;
    // For SOLIDUS, GREATER-THAN SIGN, and ***REMOVED***, spec says "reconsume in
