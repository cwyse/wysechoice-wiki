 ...
 * ***REMOVED***, after which the lexer will repeatedly return the same ***REMOVED*** token
 * whenever called.
 */
var Lexer = /*#__PURE__*/function () {
  ...
  _proto.lookahead = function lookahead() {
    ...
    if (token.kind !== _tokenKind.TokenKind.***REMOVED***) {
      do {
        var _token$next;
...
function printCharCode(code) {
  return (// NaN/undefined represents access beyond the end of the file.
    isNaN(code) ? _tokenKind.TokenKind.***REMOVED*** : // Trust JSON for ASCII.
...
function readToken(lexer, prev) {
  ...
  if (pos >= bodyLength) {
    return new _ast.Token(_tokenKind.TokenKind.***REMOVED***, bodyLength, bodyLength, line, col, prev);
  }
