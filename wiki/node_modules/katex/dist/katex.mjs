...
class Lexer {
  ...
  lex() {
    ...
    if (pos === input.length) {
      return new Token("***REMOVED***", new SourceLocation(this, pos, pos));
    }
...
class Parser {
  ...
  parse() {
    ...
    const parse = this.parseExpression(false); // If we succeeded, make sure there's an ***REMOVED*** at the end
