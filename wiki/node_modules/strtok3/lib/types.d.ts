...
export interface IReadChunkOptions {
    ...
    position?: number;
    /**
     * If set, will not throw an ***REMOVED*** error if not all of the requested data could be read
     */
    mayBeLess?: boolean;
}
/**
...
export interface ITokenizer {
     ...
     * @param maybeless - If set, will not throw an ***REMOVED*** error if the less then the requested length could be read.
     */
